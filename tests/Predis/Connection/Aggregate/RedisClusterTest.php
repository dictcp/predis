...
class RedisClusterTest extends PredisTestCase
{
    ...
    public function testCanAssignConnectionsToCustomSlots()
    {
        ...
        $expectedMap = array_merge(
            array_fill(0, 1365, array('127.0.0.1:6379')),
            array_fill(1364, 1365, array('127.0.0.1:6380')),
            array_fill(2729, 1366, array('127.0.0.1:6381'))
        );
    ...
    public function testAddingConnectionResetsSlotsMap()
    {
        ...
        $this->assertSame(array_fill(0, 4096, array('127.0.0.1:6379')), $cluster->getSlotsMap());
    ...
    public function testRemovingConnectionResetsSlotsMap()
    {
        ...
        $expectedMap = array_merge(
            array_fill(0, 2048, array('127.0.0.1:6379')),
            array_fill(2048, 2048, array('127.0.0.1:6380'))
        );
    ...
    public function testCanAssignConnectionsToCustomSlotsFromParameters()
    {
        ...
        $expectedMap = array_merge(
            ...
            array_fill(5460, 5461, array('127.0.0.1:6380')),
            array_fill(10921, 5462, array('127.0.0.1:6381'))
        );
